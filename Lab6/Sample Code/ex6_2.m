...
tgain=1./sqrt((-1.57e-7.*w.^2+1).^2+(4.15e-4.*w).^2);
...
tphase=-atan((4.15e-4.*w)./(-1.57e-7.*w.^2));

%tphase=atan(tgain);
tphase=tphase.*180./pi;

%% bode analyzer data import 
bafile='C:\Users\katez\Documents\MIZ 2021-2022\FIRST SEMESTER\Applied Electronic Instrumentation\Lab 6\Lab6\6_2BODE.txt';
...
clabfile='C:\Users\katez\Documents\MIZ 2021-2022\FIRST SEMESTER\Applied Electronic Instrumentation\Lab 6\6_2 CircuitLab.csv';
